function Barnett_2018_PLoSCompBioLocalHook
%
...
%% Say hello
fprintf('* Running Barnett_2018_PLoSCompBioLocalHook...');

%% Set preferences

% Find the project directory, add it to the path, save this as a
%  pref, and then make this the current directory
projectDir = fullfile(tbLocateProject('Barnett_2018_PLoSCompBio'));
addpath(genpath(projectDir));
setpref('Barnett_2018_PLoSCompBio', 'projectDir', projectDir);
